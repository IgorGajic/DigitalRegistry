        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Ingredient_Stock_NonNegative", "[StockQuantity] >= 0");
                    table.CheckConstraint("CK_Ingredient_Threshold_NonNegative", "[LowStockThreshold] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_MenuItem_UnitPrice_NonNegative", "[UnitPrice] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QrCodeToken = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Modified = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Table_Capacity_Positive", "[Capacity] > 0");
                    table.CheckConstraint("CK_Table_Number_Positive", "[TableNumber] > 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_RecipeItem_Quantity_Positive", "[QuantityRequired] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Reservation_Period", "[EndTime] > [StartTime]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Shift_Period", "[EndTime] > [StartTime]");
                    table.ForeignKey(
                        name: "FK_Shifts_AspNetUsers_WaiterId",
                        column: x => x.WaiterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestaurantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProcessedByWaiterId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_AspNetUsers_ProcessedByWaiterId",
                        column: x => x.ProcessedByWaiterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_RestaurantId_Role",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItems_RestaurantId_Category_IsAvailable",
                table: "MenuItems",
                columns: new[] { "RestaurantId", "Category", "IsAvailable" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeItems_MenuItemId_IngredientId",
                table: "RecipeItems",
                columns: new[] { "MenuItemId", "IngredientId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_GuestId_StartTime",
                table: "Reservations",
                columns: new[] { "GuestId", "StartTime" });

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_RestaurantId_StartTime",
                table: "Reservations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shifts_RestaurantId_StartTime",
                table: "Shifts",
                columns: new[] { "RestaurantId", "StartTime" });

            migrationBuilder.CreateIndex(
                name: "IX_Shifts_WaiterId_StartTime_EndTime",
                table: "Shifts",
                columns: new[] { "WaiterId", "StartTime", "EndTime" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_ProcessedByWaiterId",
                table: "Transactions",
                column: "ProcessedByWaiterId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_RestaurantId_ProcessedByWaiterId_TransactionDate",
                table: "Transactions",
                columns: new[] { "RestaurantId", "ProcessedByWaiterId", "TransactionDate" });

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_RestaurantId_TransactionDate",
                table: "Transactions",
                columns: new[] { "RestaurantId", "TransactionDate" });
        }
