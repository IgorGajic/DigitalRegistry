...
namespace DigitalRegistry.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260903165256_AddOrderServedBy")]
    partial class AddOrderServedBy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigitalRegistry.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<Guid?>("ServedByWaiterId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DigitalRegistry.Domain.Entities.Order", b =>
                {
                    b.HasOne("DigitalRegistry.Domain.Entities.ApplicationUser", "ServedByWaiter")
                        .WithMany()
                        .HasForeignKey("ServedByWaiterId")
                        .OnDelete(DeleteBehavior.Restrict);
